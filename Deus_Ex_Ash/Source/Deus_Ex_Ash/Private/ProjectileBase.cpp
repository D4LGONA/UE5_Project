...
void AProjectileBase::OnHit(AActor* HitActor, FVector ImpactPoint, float Damage, float DurabilityDecrease, float StaggerDuration, bool IgnoreGuard)
{
	...
	{
		// 맞은 캐릭터 데미지 적용
		HitCharacterBase->ApplyDamage(OwnerCharacterBase, this, ImpactPoint, Damage, StaggerDuration, IgnoreGuard);
